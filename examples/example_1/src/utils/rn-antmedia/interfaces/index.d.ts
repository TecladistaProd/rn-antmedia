...
import { MediaStream, RTCOfferOptions, RTCIceCandidate, MediaStreamTrack, RTCPeerConnectionConfiguration, RTCPeerConnection, MediaStreamConstraints } from 'react-native-webrtc';
...
export declare type CustomWebSocket = WebSocket & {
    sendJson: (dt: any) => void;
};
...
export interface Adaptor {
    ...
    signallingState: (streamId: string) => 'stable' | 'have-local-offer' | 'have-remote-offer' | 'have-local-pranswer' | 'have-remote-pranswer' | 'closed' | null;
